...
def player_hand_21_1(player_info, dealer_info, shuffle, cards_delt, i, bankroll):
    ...
    # split
        ...
        if fucken_idiot == 100:
            ...
            player_info, cards_delt, bankroll, decision, i = player_hand_21_1(player_info, dealer_info, shuffle,
                                                                              cards_delt, i, bankroll)
            return player_info, cards_delt, bankroll, decision, i
        elif fucken_idiot == 0:
            player_info, cards_delt, bankroll, decision, i = player_hand_21_1(player_info, dealer_info, shuffle,
                                                                              cards_delt, i, bankroll)
            player_info, cards_delt, bankroll, decision, j = player_hand_21_1(player_info, dealer_info, shuffle,
                                                                              cards_delt, len(player_info) - 1,
                                                                              bankroll)
            return player_info, cards_delt, bankroll, decision, i
    ...
    # insurance
        ...
        player_info, cards_delt, bankroll, decision, i = player_hand_21_1(player_info, dealer_info, shuffle, cards_delt,
                                                                          i, bankroll)
        return player_info, cards_delt, bankroll, decision, i
